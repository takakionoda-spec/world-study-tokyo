  ...
  pipeline: {
    ...
    sources: [
      ...
      },
      {
        ...
        category: "methods",
        filter:
          /\b(parent\w*|famil\w*|early[- ]childhood|preschool|kindergarten|home[- ]learning|study habit\w*|reading|literacy|numeracy|math fluency|sleep|screen[- ]time|teen\w*|adolescen\w*|child develop\w*|kindergart\w*|montessori|reggio|tutor\w*)\b/i,
        framing:
          "(The Hechinger Report — US education newsroom; FILTERED narrowly to parent / family / child-development / study-habit / early-childhood pieces only. The unfiltered feed is dominated by US K-12 policy, district politics, charter-school fights, and higher-ed governance — none of those translate. The filter keeps ONLY the portable parenting / learning trend stories)"
      },
      {
